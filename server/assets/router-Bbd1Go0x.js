...
const appCss = "/assets/styles-uXTrWINz.css";
...
function SiteHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 border-b border-border/60 bg-background/70 backdrop-blur-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-primary rounded-full blur-md opacity-50 group-hover:opacity-80 transition-opacity" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-9 w-9 rounded-full bg-gradient-primary flex items-center justify-center shadow-glow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-4.5 w-4.5 text-primary-foreground", strokeWidth: 2.5 }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg text-plum", children: "Frida" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-[0.2em] text-muted-foreground", children: "caminhe segura" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-1", children: links.map(({ to, label, icon: Icon2 }) => {
        const active = pathname === to || to !== "/" && pathname.startsWith(to);
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            to,
            className: `flex items-center gap-1.5 rounded-full px-4 py-2 text-sm font-medium transition-all ${active ? "bg-primary text-primary-foreground shadow-soft" : "text-foreground/70 hover:bg-blush hover:text-foreground"}`,
            children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          ...
          children: "Iniciar trajeto"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "md:hidden fixed bottom-0 inset-x-0 z-50 border-t border-border/60 bg-background/95 backdrop-blur-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-around px-2 py-2", children: links.slice(0, 5).map(({ to, label, icon: Icon2 }) => {
      const active = pathname === to || to !== "/" && pathname.startsWith(to);
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          to,
          className: `flex flex-col items-center gap-0.5 rounded-xl px-3 py-1.5 text-[10px] transition-colors ${active ? "text-primary" : "text-muted-foreground"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-5 w-5", strokeWidth: active ? 2.4 : 1.8 }),
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-7xl text-plum", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 font-display text-2xl text-foreground", children: "Caminho não encontrado" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Esta página não existe. Vamos te levar de volta com segurança." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        href: "/",
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col pb-20 md:pb-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SiteHeader, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
  ] });
}
const $$splitComponentImporter$5 = () => import("./sobre-C6g1diHA.js");
const Route$5 = createFileRoute("/sobre")({
  head: () => ({
    meta: [{
      title: "Sobre o Frida"
    }, {
      name: "description",
      content: "Conheça a história e os valores por trás da plataforma."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./perfil-B2V7zEL1.js");
const Route$4 = createFileRoute("/perfil")({
  head: () => ({
    meta: [{
      title: "Meu perfil — Frida"
    }, {
      name: "description",
      content: "Configure seus contatos de emergência e preferências de proteção."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./mapa-CMj8BoD5.js");
const Route$3 = createFileRoute("/mapa")({
  head: () => ({
    meta: [{
      title: "Mapa interativo — Frida"
    }, {
      name: "description",
      content: "Calcule a rota mais segura e ative o modo proteção durante o trajeto."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./como-funciona-DNgRmVED.js");
const Route$2 = createFileRoute("/como-funciona")({
  head: () => ({
    meta: [{
      title: "Como funciona — Frida"
    }, {
      name: "description",
      content: "Entenda passo a passo como o Frida te protege durante o trajeto."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./comentarios-TcvAUnVQ.js");
const Route$1 = createFileRoute("/comentarios")({
  head: () => ({
    meta: [{
      title: "Comentários da comunidade — Frida"
    }, {
      name: "description",
      content: "Leia e compartilhe relatos sobre a segurança das ruas."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-BePKxq5e.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Aplicativo de segurança para mulheres com rotas inteligentes, modo de proteção e check-in automático."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const SobreRoute = Route$5.update({
  id: "/sobre",
  path: "/sobre",
  getParentRoute: () => Route$6
});
const PerfilRoute = Route$4.update({
  id: "/perfil",
  path: "/perfil",
  getParentRoute: () => Route$6
});
const MapaRoute = Route$3.update({
  id: "/mapa",
  path: "/mapa",
  getParentRoute: () => Route$6
});
const ComoFuncionaRoute = Route$2.update({
  id: "/como-funciona",
  path: "/como-funciona",
  getParentRoute: () => Route$6
});
const ComentariosRoute = Route$1.update({
  id: "/comentarios",
  path: "/comentarios",
  getParentRoute: () => Route$6
});
